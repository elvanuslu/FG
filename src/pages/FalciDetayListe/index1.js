            ...
            <ImageBackground source={BgHeader} style={{ flex: 1, width: '100%', height: '100%' }}>
                ...
                <Container style={styles.container}>
                    ...
                    <ImageBackground source={FilterBar} style={{ width: '100%', height: 60, flexDirection: 'row', }}>
                        ...
                        <Body>
                            <TouchableOpacity onPress={() => this.onPressTest()} >
                                <Image style={{ width: 90, resizeMode: 'contain', marginTop: 0, marginLeft: 0 }} source={require("../../../assets/FalciListe/Filter.png")} />
                            </TouchableOpacity>
                        </Body>
                        <Right>
                            <TouchableOpacity onPress={this.onPress} >
                                <Image style={{ width: 90, resizeMode: 'contain', marginTop: -15, marginRight: 10 }} source={require("../../../assets/FalciListe/Sort.png")} />
                            </TouchableOpacity>
