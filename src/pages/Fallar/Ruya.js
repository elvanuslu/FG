                                ...
                                <Content>
                                    ...
                                    <View>
                                        ...
                                        <Form>
                                            ...
                                            <Text style={styles.labelFalcinote2}>Rüyası</Text>
                                            <View style={{
                                                borderWidth: 1, borderColor: 'rgb(204, 204, 204)', width: undefined, marginLeft: 30, margnRight: 30, marginTop: -5, marginBottom: 10
                                            }}>
                                                <Input placeholder='Rüyanız...' value={this.state.Ruya} onChangeText={(data) => this.setState({ Ruya: data })} />
                                            </View>
                                            <Text style={styles.labelFalcinote2}>Cinsiyet</Text>
                                            <View style={{
                                                borderWidth: 1, borderColor: 'rgb(204, 204, 204)', width: undefined, marginLeft: 30, margnRight: 30, marginTop: -5, marginBottom: 10
                                            }}>
                                                <Picker
...
const mapStateToProps = ({ IslemResponse }) => {
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(Ruya);